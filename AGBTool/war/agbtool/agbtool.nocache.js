...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "agbtool" because\n';
  ...
  $wnd.__gwt_activeModules['agbtool'] = {
    'moduleName' : 'agbtool',
    'bindings' : function() {
      return {};
    }
 ...
 * "/agbtool.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['agbtool'].superdevmode = true;

  var expectedSuffix = '/agbtool.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + agbtool + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:agbtool';
  var devModeSessionKey = '__gwtDevModeSession:agbtool';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/agbtool/agbtool.nocache.js';
  ...
  $wnd.__gwt_activeModules['agbtool'].canRedirect = true;
  $wnd.__gwt_activeModules['agbtool'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/agbtool?user.agent=' + ua + '&_callback=' + callback;
