...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "agbtool2" because\n';
  ...
  $wnd.__gwt_activeModules['agbtool2'] = {
    'moduleName' : 'agbtool2',
    'bindings' : function() {
      return {};
    }
 ...
 * "/agbtool2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['agbtool2'].superdevmode = true;

  var expectedSuffix = '/agbtool2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + agbtool2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:agbtool2';
  var devModeSessionKey = '__gwtDevModeSession:agbtool2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/agbtool2/agbtool2.nocache.js';
  ...
  $wnd.__gwt_activeModules['agbtool2'].canRedirect = true;
  $wnd.__gwt_activeModules['agbtool2'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/agbtool2?user.agent=' + ua + '&_callback=' + callback;
