...
$app->get('/api1.0/agbsource/:agbsourceid', function ($agbSourceId) {
	$agbSources = $GLOBALS['agbDBConnector']->getAGBSource($agbSourceId);
    echo json_encode($agbSources, JSON_UNESCAPED_UNICODE);
});

//@TODO: no agbsource class - get all agbsources
$app->get('/api1.0/agbsources/', function () {
	$agbSource = $GLOBALS['agbDBConnector']->getAllAGBSources();
    echo json_encode($agbSource, JSON_UNESCAPED_UNICODE);
});


//get latest agbversion
$app->get('/api1.0/agbversion/:agbsourceid', function ($agbSourceId) {
	$latestAgbVersion = $GLOBALS['agbDBConnector']->getLatestVersionOfDB($agbSourceId);
    echo json_encode($latestAgbVersion, JSON_UNESCAPED_UNICODE);
});

//TODO: get all versions of agbSource
$app->get('/api1.0/agbversions/:agbsourceid', function ($agbSourceId) {
    ...
    echo json_encode($versionsOfAGBSource, JSON_UNESCAPED_UNICODE);
});
